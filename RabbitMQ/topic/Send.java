 ...
 *    完全匹配的Queue中。其实在queue创建时，它会自动的以queue的名字作为routing key来绑定那个exchange。
 *  3.topic类型的Exchange在匹配规则上进行了扩展，它与direct类型的Exchange相似，
...
public class Send {
    ...
    public static void main(String[] args) throws Exception {
        ...
        channel.basicQos(1);
        String routingKey = "goods.add.123"; //路由key
        //发送信息
        String msg = "send goods..";
